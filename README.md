...
<h3 align="left">Code is to help someone somewhere</h3>

<p> I spend a large part of my day coding, turning ideas into actions and at the same time developing solutions in the form of software using my knowledge in JavaScript, building web applications with React, mobile applications using React-Native and RESTful APIs using NodeJS.

Always remembering, you are not alone, clean code!.</p>
